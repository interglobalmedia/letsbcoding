...
<div class="hero-slider">
  ...
  while($sliderPosts->have_posts()) {
    $sliderPosts->the_post(); ?>
      <div class="hero-slider__slide" style="background-image: url(<?php $slideImage = get_field('slide_photograph'); echo $slideImage['sizes']['pageBanner'] ?>);">
        <div class="hero-slider__interior container">
          <div class="hero-slider__overlay">
            <h2 class="headline headline--medium t-center"><?php the_field('slide_title'); ?></h2>
            <p class="t-center no-overflow"><?php the_field('slide_subtitle'); ?></p>
