(window["webpackJsonp_letsbcoding_theme"] = window["webpackJsonp_letsbcoding_theme"] || []).push([["style-index"],{
...
/******/
/******/ 	var jsonpArray = window["webpackJsonp_letsbcoding_theme"] = window["webpackJsonp_letsbcoding_theme"] || [];
...
class MyNotes {
  ...
  async createNote() {
    ...
    try {
      const response = await axios__WEBPACK_IMPORTED_MODULE_0___default.a.post(`${bcodingData.root_url}/wp-json/wp/v2/note/`, newNote);
      console.log(response.data);
